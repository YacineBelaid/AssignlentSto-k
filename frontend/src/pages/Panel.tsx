...
export function Panel() {
    ...
    return (
        <>
            <Nav />
            <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 h-screen content-center">
                            ...
                            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                ...
                                <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown" className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                                    ...
                                    <div id="filterDropdown" className="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                                        <h6 className="mb-3 text-sm font-medium text-gray-900 dark:text-white">Sort by</h6>
                                        <ul className="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                            <li className="flex items-center">
                                                <input id="ShortLinkAlpha" type="checkbox" value="" className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                </input>
                                                <label htmlFor="apple" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Newest</label>
                                            </li>
                                            <li className="flex items-center">
                                                ...
                                                <label htmlFor="fitbit" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Most Clicks</label>
                                            </li>
                                            <li className="flex items-center">
                                                ...
                                                <label htmlFor="razor" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Oldest</label>
                                            </li>
                                            <li className="flex items-center">
                                                ...
                                                </input> <label htmlFor="nikon" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Alphabetical decreasing</label>
                                            </li>
                                            <li className="flex items-center">
                                                ...
                                                <label htmlFor="benq" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Alphabetical increasing</label>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        <th scope="col" className="px-4 py-3">ShortLink</th>
                                ...
                                <tbody>
                                {urls && Object.keys(urls).length > 0 ? ( Object.entries(urls).map(([key, urlRow]: [string, urlData]) => (
                                        <tr key={key} className="border-b dark:border-gray-700">
                                            <th scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{urlRow.Shortlink}</th>
                                            <td className="px-4 py-3">{urlRow.URL}</td>
                                            <td className="px-4 py-3">{urlRow.Clicks}</td>
                                            <td className="px-4 py-3">{urlRow.CreatedAt}</td>
                                            <td className="px-4 py-3">{urlRow.UpdatedAt}
                                        ...
                                        <tr>
                                             <td colSpan={5} className="text-center py-4">No ShortLink</td>
                                        </tr>
                                    )}
